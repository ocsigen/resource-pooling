...
(* OASIS_START *)
(* DO NOT EDIT (digest: 9cac867c1e3fa629ed99e73ad121b11e) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          oasis_version = "0.4";
          ocaml_version = Some (OASISVersion.VGreaterEqual "4.06");
          version = "0.5.1";
          license =
          ...
          homepage = Some "https://github.com/ocsigen/resource-pooling";
          bugreports = None;
          synopsis =
            ...
            [
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/ocsigen/resource-pooling.git";
                      src_repo_browser =
                        Some "https://github.com/ocsigen/resource-pooling";
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Resource_pool"; "Server_pool"];
                      lib_pack = false;
     ...
     oasis_digest = Some "\181(e\240\184\177\154gd\165\141\\\175\011\004e";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
