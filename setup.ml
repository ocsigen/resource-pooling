...
(* OASIS_START *)
(* DO NOT EDIT (digest: 0d595ffbc56d5e26a9879f4f6736c3cd) *)
(*
...
let setup_t =
  {
                        ...
                        [
                           FindlibPackage
                             ("lwt",
                               Some
                                 (OASISVersion.VAnd
                                    (OASISVersion.VGreaterEqual "2.4.7",
                                      OASISVersion.VLesser "4.0.0")));
     ...
     oasis_digest = Some "r`\207pg\226B\160\156A3^c\153J\249";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
